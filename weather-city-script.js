...
let nguon = document.getElementsByClassName("nguon"),
  i;
...
let list_silde = document.getElementsByClassName("item"),
  k;
...
//hieu ung click like
function click_like() {
  let list_like = document.getElementsByClassName("like"),
    i;
  for (i = 0; i < list_like.length; i++) {
    list_like[i].addEventListener("click", function() {
      let value_node = this.value,
        count_like,
        like_1;
      switch (value_node) {
        case "like1":
...
function click_Info() {
  let list_Info = document.getElementsByClassName("class_info"),
    i,
    count_view;
